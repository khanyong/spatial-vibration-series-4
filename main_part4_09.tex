...
\begin{equation}
S \propto Q_T = \frac{g^2}{32\pi^2} \int d^4x \, \mathrm{Tr}(F_{\mu\nu} \tilde{F}^{\mu\nu}) = n \quad (n \in \mathbb{Z})
\end{equation}
