...
\begin{itemize}
    ...
    \item The \textbf{Pauli Exclusion Principle} \cite{Pauli1925} for fermions is deterministically derived from the infinite repulsive geometric pressure triggered by the destructive interference of $4\pi$-twisted spinor phase planes, scaling the macroscopic mechanics of \textbf{`Cosmic Void'} formation (Part III) \cite{YooPart3} down to the subatomic realm.
